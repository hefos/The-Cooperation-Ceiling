...
aspirations, and mutation rates), no purely extrinsic parameter set exceeds the
neutral-drift baseline p_C = 1/2, whereas intrinsic dynamics and introspective
imitation routinely do. This script produces the overview figure and a LaTeX
...
figure_outputs = [
    ...
    here.parents[3] / "tex" / "figures" / "ceiling_overview" / "main.pdf",
]
table_outputs = [
    here.parents[3] / "tex" / "figures" / "ceiling_crossing_table" / "main.tex",
]

mutations = ["0.001", "0.005", "0.05", "0.1"]  # the ergodic sweep (mu > 0)
...
# Panel C: maximum p_C over the whole sweep, per N.
...
# Panel D: fraction above the ceiling as a function of r / N.
...
lines = [
    r"% Generated by assets/img/ceiling_overview/main.py. Do not edit by hand.",
