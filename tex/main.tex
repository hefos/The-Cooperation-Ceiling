...
\begin{large}
    \begin{equation}
        T_\textbf{a,b} = 
        \begin{cases}
            (\frac{\sum_{a_i = b_{I(\textbf{a,b})}}{f(a_i)}}{N\sum_{a_j}f(a_j)})(1-\sum_{k}\mu_{ik}) + (\frac{\mu_{i,\textbf{b}_I(\textbf{a,b})}}{N}) & \text{if }\textbf{b} \in \text{Neb(\textbf{a})}\text{, differing at position }I(\textbf{a,b})\\
            0 & \text{if }\textbf{b} \notin \text{Neb(\textbf{a}) and \textbf{a}}\neq \textbf{b}\\
            1 - \sum_{\textbf{b} \in S \setminus \text{\{\textbf{a}\}}}{p_{a_{I(\textbf{a,b})}\to b_{I(\textbf{a,b})}}(a_{-j})} & \text{if }\textbf{a}=\textbf{b}
        \end{cases}
...
\begin{large}
    \begin{equation}
        T_\textbf{a,b}  = 
        \begin{cases}
            (\frac{1}{N(N-1)}\sum_{a_j=b_{I(\textbf{a,b})}}\phi(\pi_{\text{I(\textbf{a,b})}}(a) - \pi_{j}(\textbf{a})))(1-\sum_{k}\mu_{ik}) + (\frac{\mu_{i,\textbf{b}_I(\textbf{a,b})}}{N}) & \text{if }\textbf{b} \in \text{Neb(\textbf{a})}\\
            0 & \text{if }\textbf{b} \notin \text{Neb(\textbf{a}) and \textbf{a}}\neq \textbf{b}\\
            1 - \sum_{\textbf{b} \in S \setminus \text{\{\textbf{a}\}}}T_{\textbf{ab}} & \text{if }\textbf{a}=\textbf{b}
        \end{cases}
...
T_{\textbf{a,b}} =
\begin{cases}
(\dfrac{1}{N(m_j - 1)} \, \phi (\Delta \pi_{I(\textbf{a,b})}))(1-\sum_{k}\mu_{ik}) + (\frac{\mu_{i,\textbf{b}_I(\textbf{a,b})}}{N})
    & \text{if } \textbf{b} \in \mathrm{Neb}(\textbf{a}) \text{ and } j = I(\textbf{a,b}),\\[1.2em]
0
    & \text{if } \textbf{b} \notin \mathrm{Neb}(\textbf{a}) \text{and \textbf{a}} \neq \textbf{b},\\[0.8em]
1 - \displaystyle\sum_{c \ne b} T_{a,c}
...
T_{\textbf{a,b}} =  \begin{cases}
    ...
    0 & \text{if \textbf{b}}\notin \text{Neb(\textbf{a}) and \textbf{a}} \neq \textbf{b}\\
    1 - \sum_{\textbf{b}\in \text{Neb(\textbf{a})}} T_{\textbf{ab}} & \text{if \textbf{a}}=\textbf{b}
\end{cases}
\end{equation}
