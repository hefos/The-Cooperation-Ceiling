...
\begin{large}
    \begin{equation}
        \frac{\sum_{a_i = b_{I(\textbf{ab})}}{e^{\frac{\beta r\sum_{j=1}^N{\alpha_j}}{N} - \alpha_i}}}{\sum_{a_i}e^{\frac{\beta r\sum_{j=1}^N{\alpha_j}}{N} - \alpha_i}}
    \end{equation}
\end{large}\\
...
\begin{large}
    \begin{equation}
        \frac{e^{\frac{\beta r\sum_{j=1}^N{\alpha_j}}{N}}\sum_{a_i = b_{I(\textbf{ab})}}{e^{ - \alpha_i}}}{e^{\frac{\beta r\sum_{j=1}^N{\alpha_j}}{N}}\sum_{a_i}e^{-C_{v_i}}} = \frac{\sum_{a_i = b_{I(\textbf{ab})}}{e^{ - \alpha_i}}}{\sum_{a_i}e^{-\alpha_i}}
    \end{equation}
\end{large}\\
