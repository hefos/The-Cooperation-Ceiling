...
\begin{scope}[shift=(P1)]
    ...
    \foreach \k/\sty/\lab in {1/cnode/$C$, 2/dnode/$D$, 3/cnode/$C$, 4/dnode/$D$} {
        ...
        \pgfmathsetmacro{\y}{\ph/1.85}
        \node[\sty] (pA\k) at (\x,\y) {\lab};
        \node[font=\sffamily\scriptsize, text=black!70] at (\x, \y+0.4) {$\pi_{\k}$};
        \node[font=\sffamily\tiny, text=black!40] at (\x, \y-0.55) {\k};
    }
    \node[note] at (\pw/2, 1.0)
        {Each player $i$ has its own payoff $\pi_i(\mathbf{a})$};
    \node[note] at (\pw/2, 0.5)
        {state $\mathbf{a}=(C,D,C,D)\in \{C,D\}^N$};
\end{scope}

% Panel C: the state space (hypercube, by number of cooperators)
\begin{scope}[shift=(P3)]
    ...
    % vertices
    \node[vtx] (v0000) at (0.55,2.4) {};
    \node[vtx] (v1000) at (1.57,3.15) {};
    \node[vtx] (v0100) at (1.57,2.65) {};
    \node[vtx] (v0010) at (1.57,2.15) {};
    \node[vtx] (v0001) at (1.57,1.65) {};
    \node[vtx] (v1100) at (2.59,3.65) {};
    \node[vhi] (v1010) at (2.59,3.15) {};
    \node[vtx] (v1001) at (2.59,2.65) {};
    \node[vtx] (v0110) at (2.59,2.15) {};
    \node[vtx] (v0101) at (2.59,1.65) {};
    \node[vtx] (v0011) at (2.59,1.15) {};
    \node[vhi] (v1110) at (3.61,3.15) {};
    \node[vtx] (v1101) at (3.61,2.7) {};
    \node[vtx] (v1011) at (3.61,2.15) {};
    \node[vtx] (v0111) at (3.61,1.65) {};
    \node[vtx] (v1111) at (4.63,2.4) {};
    \node[font=\sffamily\scriptsize, text=accent, anchor=south] at (2.59,3.2) {$\mathbf{a}$};
    \node[font=\sffamily\scriptsize, text=accent, anchor=south] at (3.61,3.2) {$\mathbf{b}$};
...
\begin{scope}[shift=(P2)]
    ...
    % right state b = AAAB  (player 2 flipped B -> A)
    \draw[rounded corners=2pt, draw=black!25, fill=black!2]
...
\begin{scope}[shift=(P4)]
    ...
    \node[dnode] (all2) at (1.0,2.6) {};
    \node[vtx]   (m1)   at (2.15,2.6) {};
    \node[vtx]   (m2)   at (3.05,2.6) {};
    \node[cnode] (all1) at (4.2,2.6) {};
    ...
    \draw[->, accent, line width=0.9pt] (all2) to[out=55,in=125] (m1);
    \draw[->, accent, line width=0.9pt] (all1) to[out=125,in=55] (m2);
